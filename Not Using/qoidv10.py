...
class QuantumCrosstalkSimulator:
    ...
    def run_parameter_sweep(self, 
                           circuit_types: List[str] = ['teleportation'],
                           crosstalk_strengths: List[float] = [0.001, 0.005, 0.01, 0.02, 0.05],
                           crosstalk_types: List[str] = ['pauli', 'zz', 'amp_phase','depolarising'],
                ...
                for strength in crosstalk_strengths:
                    for num_pairs in pair_counts:
                        ...
                        try:
                            ...
                            print("crosstalk_strength: ",result['crosstalk_strength'])
...
def main_simulation():
    ...
    #     pair_counts=[1, 2, 3, 4,5,6,7,8],
    #     shots=10000
    # )

    results_df = simulator.run_parameter_sweep(
        circuit_types=['teleportation'],
        crosstalk_strengths=[0.5],
        crosstalk_types=['depolarizing'],
        pair_counts=[1, 2,3,4,5,6],
        shots=1000
    )
...
if __name__ == "__main__":
    ...
    try:
        ...
        plt.yscale('linear')
        plt.tight_layout()
        plt.savefig('fidelity_vs_crosstalk_strength.png', dpi=300, bbox_inches='tight')
        ...
        plt.tight_layout()
        plt.savefig('effective_ops_vs_crosstalk_strength.png', dpi=300, bbox_inches='tight')
        plt.clf()  # Clear the figure for the next plot
        ...
        plt.grid(True, alpha=0.3)
        plt.tight_layout()
        plt.savefig('quantum_volume_vs_crosstalk_strength.png', dpi=300, bbox_inches='tight')
        plt.clf()  # Clear the figure for the next plot
        ...
        plt.yscale('log')
        plt.tight_layout()
        plt.savefig('info_throughput_vs_crosstalk_strength.png', dpi=300, bbox_inches='tight')
        plt.clf()  # Clear the figure for the next plot
        ...
        plt.yscale('log')
        plt.tight_layout()
        plt.savefig('error_corrected_throughput_vs_crosstalk_strength.png', dpi=300, bbox_inches='tight')
        plt.clf()  # Clear the figure for the next plot
        ...
        plt.grid(True, alpha=0.3)
        plt.tight_layout()
        plt.savefig('success_rate_vs_crosstalk_strength.png', dpi=300, bbox_inches='tight')
        plt.clf()  # Clear the figure for the next plot
        ...
        plt.xlabel('Crosstalk Strength')
        plt.tight_layout()
        plt.savefig('throughput_efficiency_heatmap.png', dpi=300, bbox_inches='tight')
        plt.clf()  # Clear the figure for the next plot
        ...
        plt.tight_layout()
        plt.savefig('purity_loss_vs_intersecting_pairs.png', dpi=300, bbox_inches='tight')
        plt.clf()  # Clear the figure for the next plot
        ...
        plt.tight_layout()
        plt.savefig('throughput_vs_complexity.png', dpi=300, bbox_inches='tight')
        plt.clf()  # Clear the figure for the next plot
